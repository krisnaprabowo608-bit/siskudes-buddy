...
export default function SPPDefinitif() {
  ...
  const handleSimpan = () => {
    ...
    if (mode === "add") {
      const newItem: SPPItem = { id: crypto.randomUUID(), jenis: "definitif", tanggalSPP: form.tanggalSPP, nomorSPP: form.nomorSPP || generateNoSPP(), uraian: form.uraian, jumlah: form.jumlah, isFinal: false, rincian: [], buktiTransaksi: [] };
      save([...items, newItem]);
      setSelected(newItem);
